...
<head>
    ...
    <meta name="description" content="La Grandee Academy">
    <!-- ========== Page Title ========== -->
    <title>MERO SCHOOL</title>
    <!-- ========== Favicon Icon ========== -->
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-dark">
                <a class="navbar-brand" href="index.php">
                    <img width=200 src="assets/images/finallogo.png"  alt="Edusquad">
                    <h4 style="color:#0c0b39"></h4>
