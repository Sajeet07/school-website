            ...
            <div class="row justify-content-center">
                <div class="col-xl-8 col-lg-10 col-md-10">
                    <div class="online-course-inner text-center">
                        <h2>Send Us Your Short Message</h2>
                        <h6>Own Your Features Learning New Skills</h6>
                        <form class="px-5 mt-5 mb-3">
                            <div class="form-row">
                                <div class="form-group col-lg-8 col-md-12">
                                    <input type="text" class="form-control"
                                           placeholder="Send us a short quote">
                                </div>
                                <div class="form-group col-lg-4 col-md-12">
                                    <button type="submit" class="btn theme-btn theme-orange mb-2 get-course">Send Quote
                                    </button>
                                </div>
                            </div>
                        </form>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-3 col-md-3">
                                        <div class="counter p-4" data-aos="fade-up" data-aos-duration="550">
                                            ...
                                            <h3 class="timer count-title2 count-number" data-to="300"
                                                data-speed="1500"></h3>
                                    ...
                                    <div class="col-lg-3 col-md-3">
                                        <div class="counter p-4" data-aos="fade-up" data-aos-duration="550">
                                            ...
                                            <h3 class="timer count-title2 count-number" data-to="1700"
                                                data-speed="1500"></h3>
                                    ...
                                    <div class="col-lg-3 col-md-3">
                                        <div class="counter mb-0 p-4" data-aos="fade-up" data-aos-duration="550">
                                            ...
                                            <h3 class="timer count-title2 count-number" data-to="11900"
                                                data-speed="1500"></h3>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 p-5" data-aos="fade-up" data-aos-duration="550">
                    <div class="sec-title bg-fill">
                        <span class="title" style="color:white !important">FAQULTY ASK QUESTION</span>
                ...
                <div class="col-md-12 contact-us-block">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-12 py-5">
                            ...
                            <div class="single-item">
                                <div class="text-center py-4">
                                    ...
                                    <h5 class="mt-3 font-weight-bold">Lorem Ipsum</h5>
                        ...
                        <div class="col-md-6 hidden-md">
                            <div class="joinus-content theme-blue2 mx-5" data-aos="zoom-in" data-aos-duration="550">
